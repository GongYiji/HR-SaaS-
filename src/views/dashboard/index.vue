      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            ...
            <p class="lastChild">{{ $store.state.user.userInfo.username }}   |  {{ $store.state.user.userInfo.companyName }}-{{ $store.state.user.userInfo.departmentName }}</p>
          </div>
        </div>
        <div class="fr" />
      </div>
  ...
  methods: {
    btnOK() {
      this.$refs.ruleForm.validate(async validate => {
        if (validate) {
          const data = { ...this.ruleForm, userId: this.$store.state.user.userInfo.userId }
